...
public class GenerateReports {
	...
	public void startExtentReport() {
		...
		extent.setSystemInfo("User Name", "Manale Aoujil");

		htmlReporter.config().setDocumentTitle("Test Execution Report");
		htmlReporter.config().setReportName("salesForces Automation tests cases");
	...
	public void logTestpassed() {
		logger.log(Status.PASS, MarkupHelper.createLabel(testcaseName + " is PASS", ExtentColor.GREEN));
	}

	public void logTestFailed() {
		logger.log(Status.FAIL, MarkupHelper.createLabel(testcaseName + " is FAIL", ExtentColor.RED));
	}
